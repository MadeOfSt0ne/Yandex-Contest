...
class BullShitTest {
    ...
    void findPosition() {
        ...
        assertEquals(1, BullShit.getPosition(list));
    }

    @Test
    void findPosition2() {
        Integer[] list = {20, 15, 10, 20, 15, 17};
        assertEquals(4, BullShit.getPosition(list));
    }

    @Test
    void findPosition3() {
        Integer[] list = {23, 12, 8, 23, 15};
        assertEquals(0, BullShit.getPosition(list));
    }

    @Test
    void findPosition4() {
        Integer[] list = {10, 27, 15, 17, 11, 30, 25, 23};
        assertEquals(3, BullShit.getPosition(list));
    }

    @Test
    void findPosition5() {
        Integer[] list = {725, 25, 107};
        assertEquals(0, BullShit.getPosition(list));
    }
    ...
    void findPosition10() {
        ...
        assertEquals(5, BullShit.getPosition(list));
    }

    @Test
    void findPosition11() {
        Integer[] list = {1000, 995, 990};
        assertEquals(2, BullShit.getPosition(list));
    }
}